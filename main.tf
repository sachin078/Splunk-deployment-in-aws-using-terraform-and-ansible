resource "aws_instance" "testsplunk" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "wget -O splunk-your version -78803f08xxxxx-linux-2.6-amd64.deb 'https://download.splunk.com/products/splunk/releases/9.x.x/linux/splunk-9.0.1-78803fxxxx-linux-2.6-amd64.deb'",
